...
export default function SignupFormDemo() {
  ...
  return (
    <div className="w-full library py-0 md:py-2 h-[93vh]">
      <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black filter-color">
        ...
        <form className="my-10" onSubmit={handleSubmit}>
          ...
          <LabelInputContainer className="mb-10">
            ...
            <Input id="CNE" placeholder="M123456789" type="text" className="rounded"/>
          </LabelInputContainer>
          <LabelInputContainer className="mb-8">
            <Label htmlFor="twitterpassword">Mot de passe</Label>
            <Input id="twitterpassword" placeholder="••••••••" type="password" className="rounded"/>
          </LabelInputContainer>
  
          <button
            className="bg-gradient-to-br rounded relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            type="submit"
          >
            Sign up &rarr;
            <BottomGradient />
